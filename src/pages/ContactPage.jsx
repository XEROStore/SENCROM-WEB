    ...
    >
      <AnimatedSection className="section-padding bg-sencrom-gray">
        <div className="container-custom text-center">
          <Mail className="h-16 w-16 text-electric-green mx-auto mb-6" />
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Ponte en <span className="gradient-text">Contacto</span></h1>
